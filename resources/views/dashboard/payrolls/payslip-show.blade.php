        ...
        <div class="col-12 col-lg-9 col-xl-12">
            ...
            <div class="card shadow-sm payslip-card" id="payslip-print-area">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                        ...
                        <div class="text-end">
                            <div class="small text-black opacity-75 mt-1">
                                Payment Date : <strong
                                    class="text-black">{{ $payroll->pay_date?->translatedFormat('d F Y') ?? '-' }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $typeColor =
                                                    $type === 'fulltime' ? 'bg-primary' : 'bg-warning text-dark';
                                            @endphp
                ...
                <div class="text-center text-muted small py-5">
                    This document is generated automatically by the {{ Brand::fullName() }} system.
