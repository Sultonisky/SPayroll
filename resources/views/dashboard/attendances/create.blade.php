            ...
            <div class="card mb-4 shadow-sm">
                <div
                    ...
                    <h5 class="mb-0 fw-bold text-primary fs-5 fs-md-4">
                        <i class="fas fa-calendar-check me-2"></i>Add New Attendance
                    </h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="month" min="1" max="12"
                                        ...
                                        placeholder="Enter month (1-12)" value="{{ old('month') }}" required>
                                </div>
                                @error('month')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="work_days" min="0"
                                        ...
                                        placeholder="Enter work days" value="{{ old('work_days') }}" required>
                                </div>
                                @error('work_days')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="present" min="0"
                                        ...
                                        placeholder="Enter present days" value="{{ old('present') }}" required>
                                </div>
                                @error('present')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="sick" min="0"
                                        ...
                                        placeholder="Enter sick days" value="{{ old('sick') }}" required>
                                </div>
                                @error('sick')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="leave" min="0"
                                        ...
                                        placeholder="Enter leave days" value="{{ old('leave') }}" required>
                                </div>
                                @error('leave')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="alpha" min="0"
                                        ...
                                        placeholder="Enter alpha days" value="{{ old('alpha') }}" required>
                                </div>
                                @error('alpha')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="overtime_hours" step="0.01" min="0"
                                        ...
                                        placeholder="Enter overtime hours" value="{{ old('overtime_hours') }}" required>
                                </div>
