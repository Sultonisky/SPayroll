            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between py-3 gap-3">
                    <h5 class="mb-0 fw-bold text-primary fs-5 fs-md-4">
                        <i class="fas fa-id-card me-2"></i>Department Information
                    </h5>
                    <div class="d-flex flex-wrap gap-2">
                        @if(auth()->user()->isAdmin() || auth()->user()->role == 'HR')
                        <a href="{{ route('departments.edit', $department->id) }}" class="btn btn-warning btn-sm rounded-pill px-3 px-md-4 border shadow-sm">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-md ms-md-4 text-center text-md-start">
                            <h2 class="fw-bold text-body mb-1">{{ $department->name }}</h2>
                            <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2">
                                <span class="badge bg-body text-body border rounded-pill px-4 py-2 fs-6">
                                    <i class="fas fa-calendar-check me-2 text-info"></i>Created: {{ $department->created_at->translatedFormat('d M Y') }}
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card h-100 border-0 bg-body-tertiary shadow-sm">
                                <div class="card-body p-3">
                                    <div class="text-uppercase small fw-bold text-primary mb-2">Department Name</div>
                                    <div class="fs-5 fw-bold text-body">{{ $department->name }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="card h-100 border-0 bg-body-tertiary shadow-sm">
                                <div class="card-body p-3">
                                    <div class="text-uppercase small fw-bold text-primary mb-2">Department ID</div>
                                    <div class="fs-5 fw-bold text-body">#{{ str_pad($department->id, 5, '0', STR_PAD_LEFT) }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-xl-4">
                            <div class="card h-100 border-0 bg-body-tertiary shadow-sm">
                                <div class="card-body p-3">
                                    ...
                                    <div class="fs-6 fw-normal text-body">{{ $department->description }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="card h-100 border-0 bg-body-tertiary shadow-sm">
                                <div class="card-body p-3">
                                    ...
                                    <div class="fs-6 fw-bold text-body">{{ $department->created_at->translatedFormat('d F Y, H:i') }} WIB</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            <div class="card h-100 border-0 bg-body-tertiary shadow-sm">
                                <div class="card-body p-3">
                                    ...
                                    <div class="fs-6 fw-bold text-body">{{ $department->updated_at->translatedFormat('d F Y, H:i') }} WIB</div>
                                </div>
                            </div>
                        </div>
                    </div>
