...
<head>
    ...
    <title>Payslip Verification — {{ Brand::name() }}</title>
...
<body>
    ...
    <div class="verify-card">
        ...
        <div class="verify-header">
            ...
            <p>Verify the authenticity of a payslip document issued by {{ Brand::fullName() }}.</p>
        </div>
            ...
            <form method="POST" action="{{ route('verify.payslip') }}" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="doc_id"
                        ...
                        placeholder="SCR-00042-A3F9C1D82E4B" value="{{ old('doc_id') }}" maxlength="22" autofocus>
                    @error('doc_id')
        ...
        <div class="verify-footer">
            ...
            &copy; {{ date('Y') }} <a href="{{ url('/') }}">{{ Brand::fullName() }}</a>
            &nbsp;&bull;&nbsp;
