    ...
    <div class="login-container">
        <div class="login-card">
            <div class="logo-section">
                ...
                <p class="logo-tagline">{!! nl2br(e(Brand::tagline())) !!}</p>

                {{-- Live Demo Banner --}}
                <div class="demo-banner">
                    <div class="demo-banner-badge">Live Demo</div>
                    <p class="demo-banner-desc">
                        This is a live demo of <strong>Scroll</strong> - an open source, self-hosted payroll system you
                    ...
                    <div class="demo-banner-links">
                        <a href="https://github.com/Sultonisky/Scroll" target="_blank" rel="noopener noreferrer"
                            class="demo-link demo-link-github">
                            <i class="fab fa-github me-1"></i> GitHub
                        </a>
                        <a href="https://github.com/Sultonisky/Scroll#readme" target="_blank" rel="noopener noreferrer"
                            class="demo-link demo-link-docs">
                            <i class="fas fa-book me-1"></i> Documentation
                        </a>
                        <a href="https://saweria.co/sultonisky" target="_blank" rel="noopener noreferrer"
                            class="demo-link demo-link-donate">
            ...
            <div class="form-section">
                <div class="form-center">
                    <div class="login-header">
                        <p class="welcome-text">Welcome back to {{ Brand::name() }}!<br><span>Sign in to your
                                account</span></p>
                    </div>
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group-custom">
                                    ...
                                    <input type="password" name="password" class="form-input" id="pw"
                ...
                <div class="login-footer">
                    <p>{!! Brand::footerText() !!}.<br>
                        {!! Brand::authorHtml() !!}
                        &bull;
                        <a href="https://github.com/Sultonisky/Scroll#readme" target="_blank"
                            rel="noopener noreferrer" class="text-decoration-none text-body">
